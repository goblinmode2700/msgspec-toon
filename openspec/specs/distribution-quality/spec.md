...
by compatibility review. Every interaction declared supported SHALL run a
value-to-text-to-typed-value probe and SHALL appear in generated compatibility evidence.

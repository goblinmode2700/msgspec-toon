...
| Type-support boundaries | **generated, not asserted**: 9 supported, 1 parity-rejects, 13 unsupported, 3 silently ignored, **0 silently wrong** | `conformance/support_matrix.py`, `tests/test_support_matrix.py` |
